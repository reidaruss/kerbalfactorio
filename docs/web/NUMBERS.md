...
| BT-60 to BT-79 | build-tooling, SwiftShader probe-failure diagnosis on claude-dev (BT-38 follow-up; gates the 4-shard sweep) | allocated 2026-08-10 |
...
| RN-1450 to RN-1499 | rendering/asset, the ruin mesh (build_ruin.py, contracts entry, LODs, collision, weathering under ART-DIRECTION.md) | allocated 2026-08-11 |
...
| GP-520 to GP-532 | gameplay, map marker substrate + milestone bus (grantMilestone; wires the inert Research.earn, ReachedOrbit grant) | allocated 2026-08-11, not yet dispatched |
