...
| GP-600 to GP-625 | gameplay, the research station machine (D-019 confirmed): entity, recipe, build tile, panel gate, objective rung | allocated 2026-08-11 |
| GP-650 to GP-669 | gameplay, the map body-identity defect (Reid 2026-08-11: station drawn orbiting the moon, stale body visual after switch) | allocated 2026-08-11 |
...
| WG-151 to WG-165 | world-gen, the POI bridge at ABI 23 (of_poi_api.inc per world-gen.md:167, known/visited bits, client Sites.ts) | allocated 2026-08-11, not yet dispatched |
