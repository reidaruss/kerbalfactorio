...
- #8b (self, quick): harden `test_persistence_file.cpp` temp dir to be PID-unique — two agents hit a concurrent-ctest deadlock on its shared temp path. Removes recurring overnight noise.
