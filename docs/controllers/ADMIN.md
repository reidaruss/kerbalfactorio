...
| Scanning spine scope | gameplay Opus lane (read-only, local) | Work-item graph for antenna/reveal/ruins/enemies/loose-stones/pickaxe per storyline + Reid's rulings | none (asks for blocks) | **RUNNING** |
