...
| 9 | build-tooling | pre-build | **Created (idle) ✓** | git, toolchain, headless harness, CI, assets | NEW 2026-06-14 — owns Q7; idle until build greenlit |
