...
> **Domain owner:** `gameplay-controller` · **Reports to:** Admin · **Phase:** 1 · **Status:** Phase-1 designed + **Wave-0 gameplay-logic core BUILT & GREEN** (registry/inventory/mining/build/recipes/objective-FSM; `gameplay_tests` + all 6 ctest suites pass) · C-3 pinned, C-4/C-5 finalized, slice content pinned · **Last updated:** 2026-06-14
