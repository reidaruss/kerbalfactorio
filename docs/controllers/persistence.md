...
> **Domain owner:** `persistence-controller` · **Reports to:** Admin · **Phase:** 1 · **Status:** Wave-0 headless core + Wave-1 atomic single-slot FILE container built + green (seed+diff format round-trip + write-temp-then-rename disk commit proven; 8/8 ctest suites pass) · **Last updated:** 2026-06-15
