...
PALETTE = {
    ...
    # rendering.md 2.48 rather than swept in here.
    #
    ...
    #
    # THE ROUGHNESS CARRIES THE SHEEN AND THE SWING, NOT THE WARM RECOVERY.
    # Measured by isolation at merge (RN-2700 verifier, mtnslope row 191, each
    # term swapped alone on the new mesh): the hex carries +25.23 of the
    # +28.80-count warm recovery (88 per cent) and the roughness +3.79 (13 per
    # cent), nearly additive; what the roughness DOES own is essentially the
    # whole 19-count lit-luma fall (207.55 to 188.69 with the hex held) and
    # about half the lit-minus-shaded swing collapse. At 0.25 the shipped
    # material carries a
    ...
    # truthfully. See rendering.md 2.48 for what a real snow BSDF would owe.
