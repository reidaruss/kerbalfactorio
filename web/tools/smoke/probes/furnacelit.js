...
(async () => {
  ...
  //
  // GP-997. TWO SWEEPS WITH THE PICKAXE CRAFTED BETWEEN THEM, the same
  ...
  // took a ToolRequired refusal on every iron swing and never had 2 Raw iron
  // to pay the furnace. Wood and loose stone stay ungated so the pickaxe
  ...
  if (!pickaxe) {
    return { fail: 'could not craft the crude pickaxe, so no ore could be '
      + 'legally mined', carried: of.game().carried };
  }
