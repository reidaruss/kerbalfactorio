...
import { assistedFor, restoreAssisted } from './Assisted.js';
...
import type { SaveSlot, SlotRead } from './SaveGameTypes.js';

export type { SaveBuilding, SaveMachine, SaveStation, SaveSlot, SaveProgress,
  SaveHotbar, SlotRefusal, SlotRead } from './SaveGameTypes.js';
