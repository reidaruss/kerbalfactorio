...
export function installTerrainArtHandle(s: TerrainUniformState): void {
  ...
  (self as unknown as Record<string, unknown>).__ofTerrainArt = {
    ...
    treeline(): {
      ...
      floorShade: number; stand: number; floorLaw: number; grove: number;
      ...
      return {
        ...
        // RN-2661/RN-2665. The two structure arms as the SHADER holds them, on
