 ...
 * rendering.md 2.42 has the four-pose table.
 */
 ...
 * third time. See rendering.md 2.42.
 *
 * ---------------------------------------------------------------------------
 ...
 *
 * WHICH ONE SHIPS IS A MEASUREMENT AND IS RECORDED IN rendering.md 2.42, not
...
/** The default. See rendering.md 2.42 for the four-pose table that chose it. */
